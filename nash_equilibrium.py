...
def co_evolution(population_u: List[list], population_v: List[list], fitness_scores: dict = FITNESS_DICT, scaling_factor: float = 0.1, use_fitness_ordering: bool = False) -> None:
    """
...
#                 total_fitness_improvement += fitness_difference
#                 total_mutations += 1

#                 if fitness_difference > convergence_threshold:
#                     average_fitness_improvement = total_fitness_improvement / total_mutations
#                     print(f"Average Fitness Improvement (before returning False): {average_fitness_improvement}")
#                     return False  # Significant improvement found, not at Nash Equilibrium

#     if total_mutations > 0:
#         average_fitness_improvement = total_fitness_improvement / total_mutations
#         print(f"Average Fitness Improvement (Nash Equilibrium): {average_fitness_improvement}")
#     else:
#         print("No mutations performed for Nash Equilibrium check.")
